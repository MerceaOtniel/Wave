...
import com.spotify.sdk.demo.api.WaveTask;
...
public class RemotePlayerActivity extends FragmentActivity {
    ...
    public static final String REDIRECT_URI = "comspotifytestsdk://callback";
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        new Timer().schedule(new WaveTask(this), 0, 200);
    }
    ...
    public void turnVolumeUp(){
        ...
        mSpotifyAppRemote.getPlayerApi()
                .getPlayerState()
                .setResultCallback(empty -> logMessage("Volume Up!"));
    }
    ...
    public void turnVolumeDown(){
        ...
        mSpotifyAppRemote.getPlayerApi()
                .getPlayerState()
                .setResultCallback(empty -> logMessage("Volume Down!"));
    }
    ...
    public void muteOrUnmuteVolume(){
        if(audioManager.isStreamMute(AudioManager.STREAM_MUSIC)){
            ...
            mSpotifyAppRemote.getPlayerApi()
                    .getPlayerState()
                    .setResultCallback(empty -> logMessage("Unmute"));
        } else{
            audioManager.setStreamMute(AudioManager.STREAM_MUSIC, true);
            mSpotifyAppRemote.getPlayerApi()
                    .getPlayerState()
                    .setResultCallback(empty -> logMessage("Mute"));
        }
    }
    ...
    public static void setmSpotifyAppRemote(SpotifyAppRemote mSpotifyAppRemote) {
        RemotePlayerActivity.mSpotifyAppRemote = mSpotifyAppRemote;
    }

    public Button getmConnectButton() {
        return mConnectButton;
    }

    public void setmConnectButton(Button mConnectButton) {
        this.mConnectButton = mConnectButton;
    }

    public Button getmConnectAuthorizeButton() {
        return mConnectAuthorizeButton;
    }

    public void setmConnectAuthorizeButton(Button mConnectAuthorizeButton) {
        this.mConnectAuthorizeButton = mConnectAuthorizeButton;
    }

    public Button getmSubscribeToPlayerContextButton() {
        return mSubscribeToPlayerContextButton;
    }

    public void setmSubscribeToPlayerContextButton(Button mSubscribeToPlayerContextButton) {
        this.mSubscribeToPlayerContextButton = mSubscribeToPlayerContextButton;
    }

    public Button getmPlayerContextButton() {
        return mPlayerContextButton;
    }

    public void setmPlayerContextButton(Button mPlayerContextButton) {
        this.mPlayerContextButton = mPlayerContextButton;
    }

    public Button getmSubscribeToPlayerStateButton() {
        return mSubscribeToPlayerStateButton;
    }

    public void setmSubscribeToPlayerStateButton(Button mSubscribeToPlayerStateButton) {
        this.mSubscribeToPlayerStateButton = mSubscribeToPlayerStateButton;
    }

    public Button getmPlayerStateButton() {
        return mPlayerStateButton;
    }

    public void setmPlayerStateButton(Button mPlayerStateButton) {
        this.mPlayerStateButton = mPlayerStateButton;
    }

    public ImageView getmCoverArtImageView() {
        return mCoverArtImageView;
    }

    public void setmCoverArtImageView(ImageView mCoverArtImageView) {
        this.mCoverArtImageView = mCoverArtImageView;
    }

    public AppCompatTextView getmImageLabel() {
        return mImageLabel;
    }

    public void setmImageLabel(AppCompatTextView mImageLabel) {
        this.mImageLabel = mImageLabel;
    }

    public AppCompatTextView getmImageScaleTypeLabel() {
        return mImageScaleTypeLabel;
    }

    public void setmImageScaleTypeLabel(AppCompatTextView mImageScaleTypeLabel) {
        this.mImageScaleTypeLabel = mImageScaleTypeLabel;
    }

    public AppCompatImageButton getmToggleShuffleButton() {
        return mToggleShuffleButton;
    }

    public void setmToggleShuffleButton(AppCompatImageButton mToggleShuffleButton) {
        this.mToggleShuffleButton = mToggleShuffleButton;
    }

    public AppCompatImageButton getmPlayPauseButton() {
        return mPlayPauseButton;
    }

    public void setmPlayPauseButton(AppCompatImageButton mPlayPauseButton) {
        this.mPlayPauseButton = mPlayPauseButton;
    }

    public AppCompatImageButton getmToggleRepeatButton() {
        return mToggleRepeatButton;
    }

    public void setmToggleRepeatButton(AppCompatImageButton mToggleRepeatButton) {
        this.mToggleRepeatButton = mToggleRepeatButton;
    }

    public AppCompatSeekBar getmSeekBar() {
        return mSeekBar;
    }

    public void setmSeekBar(AppCompatSeekBar mSeekBar) {
        this.mSeekBar = mSeekBar;
    }

    public AppCompatImageButton getmPlaybackSpeedButton() {
        return mPlaybackSpeedButton;
    }

    public void setmPlaybackSpeedButton(AppCompatImageButton mPlaybackSpeedButton) {
        this.mPlaybackSpeedButton = mPlaybackSpeedButton;
    }
    ...
    public TrackProgressBar getmTrackProgressBar() {
        return mTrackProgressBar;
    }

    public void setmTrackProgressBar(TrackProgressBar mTrackProgressBar) {
        this.mTrackProgressBar = mTrackProgressBar;
    }

    public Subscription<PlayerState> getmPlayerStateSubscription() {
        return mPlayerStateSubscription;
    }

    public void setmPlayerStateSubscription(Subscription<PlayerState> mPlayerStateSubscription) {
        this.mPlayerStateSubscription = mPlayerStateSubscription;
    }

    public Subscription<PlayerContext> getmPlayerContextSubscription() {
        return mPlayerContextSubscription;
    }

    public void setmPlayerContextSubscription(Subscription<PlayerContext> mPlayerContextSubscription) {
        this.mPlayerContextSubscription = mPlayerContextSubscription;
    }

    public Subscription<Capabilities> getmCapabilitiesSubscription() {
        return mCapabilitiesSubscription;
    }

    public void setmCapabilitiesSubscription(Subscription<Capabilities> mCapabilitiesSubscription) {
        this.mCapabilitiesSubscription = mCapabilitiesSubscription;
    }

    public ErrorCallback getmErrorCallback() {
        return mErrorCallback;
    }

    public Subscription.EventCallback<PlayerContext> getmPlayerContextEventCallback() {
        return mPlayerContextEventCallback;
    }

    public Subscription.EventCallback<PlayerState> getmPlayerStateEventCallback() {
        return mPlayerStateEventCallback;
    }
}
